...
import { AgreeWith, CreateAccount, CreateYourAccount, EmailAddress, EnterYourPersonalDetails, GmailHeading, HaveAccount, Href, Password, PrivacyPolicy, SignIn, SignUpWith, YourName } from '../../../../utils/Constant';
          ...
          <Form className="theme-form"  onSubmit={(event) => event.preventDefault()}>
            ...
            <div className="social mt-4">
              <div className="btn-showcase">
                <Link className="btn btn-light" to="https://accounts.google.com/" target="_blank" rel="noreferrer">
                  <Mail className="txt-mail" /> {GmailHeading}
                </Link>
              </div>
            </div>
